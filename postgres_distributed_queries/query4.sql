...
WITH year_total AS
    (SELECT c_customer_id customer_id ,
            ...
            's' sale_type
     FROM postgres_ds2.public.customer ,
          postgres_ds1.public.store_sales ,
     ...
     UNION ALL SELECT c_customer_id customer_id ,
                      ...
                      'c' sale_type
     FROM postgres_ds3.public.customer ,
          postgres_ds2.public.catalog_sales ,
